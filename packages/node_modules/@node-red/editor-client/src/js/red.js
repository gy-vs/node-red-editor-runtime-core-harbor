        ...
        RED.comms.subscribe("notification/node/#",function(topic,msg) {
            ...
            if (topic == "notification/node/added") {
                ...
                for (i=0;i<msg.length;i++) {
                    m = msg[i];
                    if (m.plugins) {
                        var pluginModuleExisted = !!RED.plugins.getModule(m.module);
                        m.plugins.forEach(function(p) {
                            RED.plugins.removePlugin(p.id);
                        });
                        if (pluginModuleExisted && !RED.plugins.getModule(m.module)) {
                            RED.events.emit("registry:plugin-module-removed",m.module);
                        }
                    } else {
